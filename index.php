...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="rocket-icon-filled-flat-sign-solid-pictogram-isolated-on-white-startup-symbol-logo-illustration-pixel-perfect-vector__1_-removebg-preview.png" alt=""/>
                        <h3>Welcome</h3>
